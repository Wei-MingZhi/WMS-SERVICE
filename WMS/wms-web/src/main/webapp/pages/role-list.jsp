...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<ol class="breadcrumb">
			...
			<li>
				<a href="${pageContext.request.contextPath}/role/role-list.do">角色管理</a>
			</li>
								...
								<c:forEach items="${roleList}" var="role">
									<tr>
										...
										<td class="text-center">
											<a href="${pageContext.request.contextPath}/role/role-by-id.do?id=${role.id}" class="btn btn-primary">权限详情</a>
											<a href="${pageContext.request.contextPath}/role/del-role.do?id=${role.id}" class="btn btn-danger">删除角色</a>
											<a href="${pageContext.request.contextPath}/role/select-role-permission.do?roleId=${role.id}" class="btn btn-info">添加权限</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
