    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/users/users-list.do">人员管理</a>
                </li>
        ...
        <!-- 正文区域 -->
        <form action="${pageContext.request.contextPath}/users/add-user-to-role.do" method="post">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${roleList}" var="role">
                                <tr>
                                    ...
                                    <td>${role.roleDesc }</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/users/add-user-to-role.do?userId=${users.id}&roleId=${role.id}" class="btn bg-olive btn-xs">添加此角色</a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
