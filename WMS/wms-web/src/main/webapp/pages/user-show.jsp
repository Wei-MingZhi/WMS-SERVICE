					...
					<div class="table-box">
						...
						<div class="tab-pane" id="tab-treetable">
							<table id="collapse-table" class="table table-bordered table-hover dataTable">
								...
								<tbody>
									<c:forEach items="${users.roleList}" var="role" varStatus="vs">
										<tr data-tt-id="${vs.index+1}" data-tt-parent-id="0">
											<td>${role.roleName }</td>
											<td>${role.roleDesc }</td>
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/users/del-user-role.do?userId=${users.id}&roleId=${role.id}" class="btn bg-olive btn-xs" >删除角色</a>
											</td>
										</tr>
